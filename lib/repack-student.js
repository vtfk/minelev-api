...
module.exports = (student, removeGroups, removeUtdProg) => {
  ...
  return {
    ...
    programomraade: removeUtdProg ? undefined : student.programomraade.map(repackUtdprogData)[0],
    utdanningsprogram: removeUtdProg ? undefined : student.utdanningsprogram.map(repackUtdprogData)[0],
    groups: removeGroups ? undefined : student.groups.map(repackGroups)
  }
}
